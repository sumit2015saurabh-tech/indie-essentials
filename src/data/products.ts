...
export const PRODUCTS: Product[] = [
  {
    ...
    image: `${B}images/products/ayurvedic.jpg`, badge: 'Bestseller', verified: true,
  ...
  },
  {
    ...
    image: `${B}images/products/shilajit.jpg`, badge: 'Premium', verified: true,
  ...
  {
    id: 'p20', name: 'Indie Stamina Builder Syrup', slug: 'stamina-builder-syrup',
    category: 'ayurvedic', price: 999, originalPrice: 1199, rating: 4.9, reviews: 487,
    image: `${B}images/products/stamina-syrup.jpg`, badge: 'Indie Signature', verified: true,
    description: 'Our signature 100ml Ayurvedic stamina syrup — a potent blend of ashwagandha, safed musli, shilajit and gokshura for energy, endurance and vitality. GMP-certified, lab-tested.',
    benefits: ['100ml herbal syrup', 'Boosts stamina & endurance', 'Supports natural vitality', 'Take 10ml twice daily'],
  },
  {
    id: 'p3', name: 'Kama Sutra Wellness Oil', slug: 'wellness-oil',
    category: 'ayurvedic', price: 649, rating: 4.7, reviews: 156,
    image: `${B}images/products/oil.jpg`, verified: true,
  ...
  },
  {
    ...
    image: `${B}images/products/vitamins.jpg`, verified: true,
  ...
  },
  {
    ...
    image: `${B}images/products/vitamins.jpg`, badge: 'New',
  ...
  },
  {
    ...
    image: `${B}images/products/sex-toy-massager.jpg`, badge: 'Top Rated', discreet: true,
  ...
  },
  {
    ...
    image: `${B}images/products/sex-toy-ring.jpg`, discreet: true,
  ...
  },
  {
    ...
    image: `${B}images/products/sex-toy-wand.jpg`, badge: 'Popular', discreet: true,
  ...
  },
  {
    ...
    image: `${B}images/products/sex-toy-bullet.jpg`, badge: 'Bestseller', discreet: true,
  ...
  },
  {
    ...
    image: `${B}images/products/sex-toy-remote.jpg`, badge: 'Couples Pick', discreet: true,
  ...
  },
  {
    ...
    image: `${B}images/products/sex-toy-wand.jpg`, discreet: true,
  ...
  },
  {
    ...
    image: `${B}images/products/sex-toy-kit.jpg`, badge: 'Starter Kit', discreet: true,
  ...
  },
  {
    ...
    image: `${B}images/products/cream.jpg`, discreet: true,
  ...
  },
  {
    ...
    image: `${B}images/products/cream.jpg`, verified: true,
  ...
  },
  {
    ...
    image: `${B}images/products/consultation.jpg`, badge: 'Expert',
  ...
  },
  {
    ...
    image: `${B}images/products/consultation.jpg`,
  ...
  },
  {
    ...
    image: `${B}images/products/consultation.jpg`, badge: 'Comprehensive',
